...
EOF
    ...
    "ldflags")
        # 输出Go ldflags格式
        echo "-X 'github.com/Tencent/Xelora/internal/handler.Version=$VERSION' -X 'github.com/Tencent/Xelora/internal/handler.Edition=$EDITION' -X 'github.com/Tencent/Xelora/internal/handler.CommitID=$COMMIT_ID' -X 'github.com/Tencent/Xelora/internal/handler.BuildTime=$BUILD_TIME' -X 'github.com/Tencent/Xelora/internal/handler.GoVersion=$GO_VERSION'"
        ;;
    "info")
        # 输出信息格式
        echo "版本信息: $VERSION"
