...
echo ">> Building Xelora-lite binary..."
export EDITION=lite
...
if [ -f deploy/xelora-lite.service ]; then
    cp deploy/xelora-lite.service "${DIST_DIR}/"
fi
