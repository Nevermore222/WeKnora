...
APP_NAME="Xelora Lite"
APP_BUNDLE="${APP_NAME}.app"
DIST_DIR="dist/${APP_BUNDLE}"

echo "=== Xelora Mac App Packager ==="
...
# 默认生成 Wails 绑定（供 window.go.main.App.* 等）；若加 -skipbindings 则需在 OnDomReady 注入 __XELORA_API_BASE__
