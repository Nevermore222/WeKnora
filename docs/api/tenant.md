...
```curl
curl --location 'http://localhost:8080/api/v1/tenants/search?keyword=xelora&page=1&page_size=10' \
--header 'Content-Type: application/json' \
--header 'X-API-Key: sk-An7_t_izCKFIJ4iht9Xjcjnj_MC48ILvwezEDki9ScfIa7KA'
```
...
--data '{
    "name": "xelora new",
    "description": "xelora tenants new",
    "status": "active",
    "retriever_engines": {
        "engines": [
            {
