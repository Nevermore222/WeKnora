...
export const useSettingsStore = defineStore("settings", {
  state: () => ({
    ...
    settings: JSON.parse(localStorage.getItem("Xelora_settings") || JSON.stringify(defaultSettings)) as Settings,
  ...
  actions: {
    ...
    saveSettings(settings: Settings) {
      ...
      // 保存到localStorage
      localStorage.setItem("Xelora_settings", JSON.stringify(this.settings));
    },
