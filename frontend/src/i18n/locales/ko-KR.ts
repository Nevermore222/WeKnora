export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "Xelora에 오신 것을 환영합니다",
        desc: "몇 단계만으로 지식 베이스, 대화, 에이전트의 핵심 사용법을 안내합니다. '다음'을 눌러 시작하세요.",
      },
      knowledge: {
        title: "지식 베이스 만들기",
        desc: "모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 Xelora가 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.",
      },
      chat: {
        title: "AI 대화 시작하기",
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: xelora/images',
      prefixPlaceholder: '예: xelora',
  ...
  system: {
    ...
    retry: "재시도",
    versionLabel: "앱 버전",
    versionDescription: "애플리케이션 서비스(xelora-app)의 버전 번호",
    frontendVersionLabel: "UI 버전",
    frontendVersionDescription: "UI(xelora-ui) 빌드 버전 번호",
  ...
  createChat: {
    title: "안녕하세요, Xelora입니다 — 당신의 지식을 손끝에",
