export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в Xelora',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и Xelora автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  settings: {
    ...
    xeloraCloud: {
      title: 'Xelora Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для Xelora Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Xelora Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Xelora Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Xelora Cloud',
      ...
      usageSteps: '1. Сохраните APPID и APPSECRET\n2. Добавьте chat, embedding, rerank и vlm в разделе «Облачные модели» ниже\n3. Парсинг: Настройки БЗ → Движок парсинга → Xelora Cloud',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные XeloraCloud настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные XeloraCloud не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные XeloraCloud настроены. Поддерживаемые модели см. в',
      modelHintDocsLink: 'документации API',
      modelsSection: {
        title: 'Облачные модели',
        descReady: 'Зарегистрируйте четыре стандартные модели Xelora Cloud для чата, поиска, реранкинга и зрения.',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. xelora/images',
      prefixPlaceholder: 'напр. xelora',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в Xelora',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (xelora-app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (xelora-ui)',
  ...
  createChat: {
    title: 'Привет, я Xelora — ваши знания всегда под рукой',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        xeloracloud: {
          name: 'Xelora Cloud',
          desc: 'Парсинг документов через Xelora Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
