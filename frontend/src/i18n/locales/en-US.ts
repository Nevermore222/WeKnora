export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and Xelora parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  resourceOrigin: {
    ...
    enterpriseTooltip: 'From enterprise server "{server}"',
    enterpriseSharedTooltip: 'Shared by organization "{org}" on enterprise server "{server}"',
  },
  knowledgeBase: {
  ...
  settings: {
    ...
    xeloraCloud: {
      title: 'Xelora Cloud',
      description: 'Configure Xelora Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'Xelora Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'Xelora Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Xelora Cloud application secret',
      ...
      credentialConfigured: 'XeloraCloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'XeloraCloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'XeloraCloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard Xelora Cloud models for chat, retrieval, reranking, and vision.',
      ...
      addModelsDisplayName: {
        chat: 'XeloraCloud Chat',
        embedding: 'XeloraCloud Embedding',
        rerank: 'XeloraCloud ReRank',
        vllm: 'XeloraCloud Vision',
      },
    },
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. xelora/images',
      prefixPlaceholder: 'e.g. xelora',
  ...
  embedPublish: {
    ...
    webhookUrlPlaceholder: 'https://your-server.example.com/xelora/embed-events',
    webhookUrlDesc: 'Optional. Xelora POSTs message_sent / message_received events to this HTTPS endpoint.',
    webhookSecret: 'Webhook secret',
    webhookSecretPlaceholder: 'HMAC-SHA256 secret (X-Xelora-Signature header)',
...
\
  ...
  chat: {
    ...
    enterpriseSessionFailed: 'Could not create a session on the enterprise server. Check the server connection.',
  },
  tenant: {
    ...
    api: {
      ...
      sandboxModeLabel: 'Skill Execution Mode',
      sandboxModeDescription:
        'Choose the runtime environment for skill scripts. "Local Process" runs directly on your machine (no Docker required); "Docker Sandbox" runs in an isolated container (requires Docker Desktop).',
      sandboxModeLocal: 'Local Process',
      sandboxModeDocker: 'Docker Sandbox',
      sandboxModeSaved: 'Execution mode switched',
      sandboxModeSaveFailed: 'Failed to switch mode',
    }
  },
  system: {
    ...
    versionDescription: 'Version of the application service (xelora-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (xelora-ui)',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        xeloracloud: {
          name: 'Xelora Cloud',
          desc: 'Document parsing via Xelora Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  enterprise: {
    ...
    description: 'Connect to Xelora enterprise servers on your LAN to access admin-managed knowledge bases, agents, and skills.',
    addServer: 'Add Server',
    addServerTitle: 'Add Enterprise Server',
    addServerConfirm: 'Add',
    cancel: 'Cancel',
    noServers: 'No enterprise servers configured. Click "Add Server" to connect a Xelora instance on your LAN.',
    fieldName: 'Name',
    fieldNamePlaceholder: 'e.g. Company Knowledge Server',
    fieldURL: 'Server URL',
    fieldToken: 'API Token',
    fieldTokenPlaceholder: 'Generate in enterprise server Settings → API Keys',
    fieldAutoConnect: 'Auto-connect on startup',
    connect: 'Connect',
    disconnect: 'Disconnect',
    test: 'Test',
    delete: 'Delete',
    deleteConfirm: 'Are you sure you want to remove this server configuration?',
    ...
    connectSuccess: 'Connected to enterprise server',
    connectFailed: 'Connection failed. Check the URL and token.',
    testReachable: 'Server is reachable',
    testUnreachable: 'Server is unreachable',
    testFailed: 'Test failed',
    deleteSuccess: 'Server removed',
    deleteFailed: 'Failed to remove server',
    formIncomplete: 'Please fill in the name and server URL',
    originEnterprise: 'Enterprise',
    originLocal: 'Local',
    indicatorMultiple: '{count} enterprise servers connected',
