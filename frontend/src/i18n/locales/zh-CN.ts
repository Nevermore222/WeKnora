export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，Xelora 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  resourceOrigin: {
    ...
    enterprise: "企业",
    enterpriseTooltip: "来自企业服务器「{server}」",
    enterpriseSharedTooltip: "由企业服务器「{server}」上的组织「{org}」共享",
  },
  knowledgeBase: {
    title: "知识库",
    list: "知识库列表",
  ...
  chat: {
    ...
    enterpriseSessionFailed: "无法在企业服务器创建会话，请检查服务器连接。",
  },
  settings: {
    title: "设置",
    modelConfig: "模型配置",
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 xelora/images",
      prefixPlaceholder: "如 xelora",
  ...
  tenant: {
    ...
    api: {
      ...
      sandboxModeLabel: "Skill 执行模式",
      sandboxModeDescription:
        "选择 Skill 脚本的运行环境。「本地进程」直接在您的电脑上执行（无需 Docker）；「Docker 沙箱」在隔离容器中执行（需安装 Docker Desktop）。",
      sandboxModeLocal: "本地进程",
      sandboxModeDocker: "Docker 沙箱",
      sandboxModeSaved: "执行模式已切换",
      sandboxModeSaveFailed: "切换失败",
    },
  },
  system: {
    title: "系统信息",
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（xelora-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（xelora-ui）的构建版本号",
  ...
  embedPublish: {
    ...
    webhookUrlDesc: "可选。访客发消息与助手回复完成时，Xelora 会向该 HTTPS 地址 POST 事件（message_sent / message_received）。",
    webhookSecret: "Webhook 签名密钥",
    webhookSecretPlaceholder: "用于 HMAC-SHA256 签名（X-Xelora-Signature）",
  ...
  enterprise: {
    title: "企业服务器",
    description: "连接局域网内的 Xelora 企业服务器，使用管理员创建的企业知识库、智能体和 Skill。",
    addServer: "添加服务器",
    addServerTitle: "添加企业服务器",
    addServerConfirm: "添加",
    cancel: "取消",
    noServers: "尚未配置企业服务器。点击「添加服务器」连接局域网内的 Xelora 实例。",
    fieldName: "名称",
    fieldNamePlaceholder: "例如：公司知识库服务器",
    fieldURL: "服务器地址",
    fieldToken: "API Token",
    fieldTokenPlaceholder: "在企业服务器「设置 → API Keys」中生成",
    fieldAutoConnect: "启动时自动连接",
    connect: "连接",
    disconnect: "断开",
    test: "测试",
    delete: "删除",
    deleteConfirm: "确定要删除此服务器配置吗？",
    statusConnected: "已连接",
    ...
    addSuccess: "服务器已添加",
    addFailed: "添加失败",
    connectSuccess: "已连接到企业服务器",
    connectFailed: "连接失败，请检查地址和 Token",
    testReachable: "服务器可达",
    testUnreachable: "服务器不可达",
    testFailed: "测试失败",
    deleteSuccess: "服务器已删除",
    deleteFailed: "删除失败",
    formIncomplete: "请填写名称和服务器地址",
    originEnterprise: "企业",
    originLocal: "本地",
    indicatorMultiple: "{count} 台企业服务器已连接",
    linkedAs: "已关联为 {email}",
  },
};
