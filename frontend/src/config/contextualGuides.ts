...
export const GLOBAL_USER_GUIDE_KEY = 'xelora:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'xelora:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'xelora:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'xelora:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'xelora:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'xelora:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'xelora:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'xelora:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'xelora:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'xelora:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'xelora:contextual-guide-agent-create:v1',
