...
const VIEW_MODE_KEY = 'xelora.kb.docs.viewMode';
...
onMounted(() => {
  ...
  window.addEventListener('xelora:open-knowledge', handleOpenKnowledgeEvent as EventListener);
});
...
onUnmounted(() => {
  ...
  window.removeEventListener('xelora:open-knowledge', handleOpenKnowledgeEvent as EventListener);
  stopMovePoll();
  if (timeout !== null) {
