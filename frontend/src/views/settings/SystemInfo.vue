...
const troubleshootingDocsURL =
  'https://github.com/Tencent/Xelora/blob/main/docs/migration-troubleshooting.md'
...
const reportIssueURL = computed(() => {
  const base = 'https://github.com/Tencent/Xelora/issues/new'
  ...
  if (errMsg) {
    const body = [
      '### Environment',
      `- Xelora version: ${systemInfo.value?.version || 'unknown'}`,
