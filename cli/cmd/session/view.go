...
// NewCmdView builds `xelora session view <id>`. Renders session metadata
...
--limit without --full is rejected as input.invalid_argument.`,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples:      []string{"xelora session view sess_abc", "xelora session view sess_abc --full --limit 50"},
