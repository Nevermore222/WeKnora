// Package sessioncmd holds `xelora session` command tree (list / view /
...
// "github.com/Tencent/Xelora/client"` and use `sdk.Session` without
...
// NewCmd builds the `xelora session` parent command.
