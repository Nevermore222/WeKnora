...
// NewCmdView builds `xelora doc view <id>`.
func NewCmdView(f *cmdutil.Factory) *cobra.Command {
	opts := &ViewOptions{}
	cmd := &cobra.Command{
		Use:   "view <doc-id>",
		Short: "Show a document by ID",
		Example: `  xelora doc view doc_abc
  xelora doc view doc_abc --format json`,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples:      []string{"xelora doc view doc_abc", "xelora doc view doc_abc --jq .data.parse_status"},
