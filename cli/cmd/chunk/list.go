...
const chunkListExample = `  xelora chunk list --doc doc_abc
  xelora chunk list --doc doc_abc --all-pages --page-size 100
  xelora chunk list --doc doc_abc --format json | jq '.[] | {id, chunk_index}'`

// NewCmdList builds `xelora chunk list --doc <doc-id>`.
func NewCmdList(f *cmdutil.Factory) *cobra.Command {
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples:      []string{"xelora chunk list --doc doc_abc --format json", "xelora chunk list --doc doc_abc --all-pages --format json"},
