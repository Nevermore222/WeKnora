...
// NewCmdView builds `xelora agent view <agent-id>`.
...
Use --jq to project specific fields or reach into nested config.`,
		Example: `  xelora agent view ag_abc
  xelora agent view ag_abc --format json --jq '{id, name, config}'   # top-level projection
  xelora agent view ag_abc --format json --jq '.config.system_prompt'`,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples:      []string{"xelora agent view agent_abc"},
