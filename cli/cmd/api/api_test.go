...
// withRootHarness wraps `xelora api ...` under a synthetic root cmd that
...
// escape-hatch DELETE path: agent invokes `xelora api DELETE /...` without
