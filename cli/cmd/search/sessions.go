...
// NewCmdSessions builds `xelora search sessions "<query>"`. Finds chat
...
to stop after one page.`,
		Example: `  xelora search sessions "onboarding"
  xelora search sessions "Q3 review" --limit 3 --format json
  xelora search sessions "Q3 review" --all-pages=false`,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples: []string{`xelora search sessions "onboarding" --format json`},
