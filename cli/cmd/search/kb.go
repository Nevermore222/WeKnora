...
// NewCmdKB builds `xelora search kb "<query>"` - substring + case-insensitive
...
content, use ` + "`xelora search chunks`" + `.`,
		Example: `  xelora search kb "marketing"
  xelora search kb "team" --limit 5 --format json`,
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples: []string{`xelora search kb "engineering" --format json`},
