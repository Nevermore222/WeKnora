...
// .xelora/project.yaml that anchors a working directory to a profile+KB.
//
// Discovery walks up from the start directory until either (a) a
// .xelora/project.yaml is found, (b) the filesystem root is reached, or
...
// Project is the on-disk schema of .xelora/project.yaml.
type Project struct {
...
// FileName is the project link file basename relative to .xelora/.
const FileName = "project.yaml"

// DirName is the project-link directory name.
const DirName = ".xelora"
...
// Creates parent .xelora/ directory if missing.
