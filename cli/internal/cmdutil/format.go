...
// DefaultFormatMode is the mode used when neither --format nor XELORA_FORMAT
...
// FromEnv reads XELORA_FORMAT and applies it when Mode hasn't been set
