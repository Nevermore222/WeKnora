...
// `xelora <command> --help` with XELORA_AGENT_HELP=1. Distinct from
...
//
// Routing:
//   - XELORA_AGENT_HELP=1: emit the AgentHelp JSON blob to stdout and
...
func SetAgentHelp(cmd *cobra.Command, ah AgentHelp) {
	...
	cmd.SetHelpFunc(func(c *cobra.Command, args []string) {
		if os.Getenv("XELORA_AGENT_HELP") == "1" {
