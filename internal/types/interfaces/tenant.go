...
type TenantService interface {
	...
	// GetXeloraCloudCredentials returns the decrypted XeloraCloud credentials for the current tenant.
	GetXeloraCloudCredentials(ctx context.Context) *types.XeloraCloudCredentials
}
