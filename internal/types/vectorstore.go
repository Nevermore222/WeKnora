	...
	return []VectorStoreTypeInfo{
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "index_name", Type: "string", Required: false, Description: "Index Name", Default: "xelora"},
		...
		// env stores when configured via RETRIEVE_DRIVER but cannot be added as DB stores.
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_prefix", Type: "string", Required: false, Description: "Collection Prefix", Default: "xelora_embeddings"},
		...
		},
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_name", Type: "string", Required: false, Description: "Collection Name", Default: "xelora_embeddings"},
		...
		},
		{
			...
			ConnectionFields: []VectorStoreFieldInfo{
				...
				{Name: "database", Type: "string", Required: false, Description: "Database", Default: "xelora"},
			},
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_name", Type: "string", Required: false, Description: "Collection Name", Default: "xelora_embeddings"},
		...
		},
		{
			...
			ConnectionFields: []VectorStoreFieldInfo{
				...
				{Name: "database", Type: "string", Required: true, Description: "Database", Default: "xelora"},
				{Name: "username", Type: "string", Required: false, Description: "Username", Default: "root"},
				{Name: "password", Type: "string", Required: false, Sensitive: true, Description: "Password"},
			},
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_prefix", Type: "string", Required: false, Description: "Table Prefix", Default: "xelora_embeddings"},
