...
type Repository struct {
	client    *osapi.Client
	baseIndex string      // pre-suffix base name, e.g. "xelora_abcdef012345"
...
//   - storeID == ""       — env-path; no prefix, base index = "xelora".
...
func NewRepository(
	...
	base := types.ResolveIndexName(indexCfg, "OPENSEARCH_INDEX", "xelora")
	if storeID != "" {
