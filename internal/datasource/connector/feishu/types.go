// Package feishu implements the Feishu (飞书/Lark) data source connector for Xelora.
//
// It syncs documents from Feishu Wiki spaces and cloud documents into Xelora knowledge bases.
//
// Feishu API docs:
