// Package yuque implements the Yuque (语雀) data source connector for Xelora.
//
// It syncs documents from personal and group knowledge bases (books/repos) into Xelora
