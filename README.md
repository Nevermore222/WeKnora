<p align="center">
  <picture>
    <img src="./docs/images/logo.png" alt="Xelora Logo" height="120"/>
  </picture>
</p>
...
<p align="center">
  <picture>
    <a href="https://trendshift.io/repositories/15289" target="_blank">
      <img src="https://trendshift.io/api/badge/repositories/15289" alt="Tencent%2FXelora | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
    </a>
  </picture>
</p>
<p align="center">
    <a href="https://xelora.weixin.qq.com" target="_blank">
        <img alt="Official Website" src="https://img.shields.io/badge/Official Website-Xelora-4e6b99">
    </a>
    ...
    <a href="https://chromewebstore.google.com/detail/jpemjbopikggjlmikmclgbmkhhopjdgd" target="_blank">
        <img alt="Chrome Extension" src="https://img.shields.io/badge/Chrome Extension-Xelora-4285F4">
    </a>
    <a href="https://clawhub.ai/lyingbug/xelora" target="_blank">
        <img alt="ClawHub Skill" src="https://img.shields.io/badge/ClawHub Skill-Xelora-ff6b35">
    </a>
    <a href="https://github.com/Tencent/Xelora/blob/main/LICENSE">
...
- **v0.5.2** — Wiki ingest scales to 40k-document KBs (task queue + DLQ); MCP human-in-the-loop tool approval; Anthropic / Apache Doris / Tencent VectorDB / KS3 / SearXNG backends; adaptive 3-tier chunking with live preview; global ⌘K command palette; Yuque connector + WeChat Mini Program; `xelora` CLI preview.
...
- **v0.4.0** — Xelora Cloud (hosted LLM + parsing); Chrome Extension; ClawHub Skill; WeChat IM; attachment processing; Azure OpenAI / Alibaba OSS; Notion connector; Baidu + Ollama web search; VectorStore management.
...
![xelora-architecture.png](./docs/images/architecture.png)
...
| UI | Web UI / RESTful API / CLI (`xelora`) / Chrome Extension / WeChat Mini Program |
...
| Model Management | Centralized config, declarative built-in models via YAML, per-knowledge-base model selection, per-model thinking-mode config, multi-tenant built-in model sharing, Xelora Cloud hosted models and parsing |

## 🧩 Chrome Extension

[**Xelora Chrome Extension**](https://chromewebstore.google.com/detail/jpemjbopikggjlmikmclgbmkhhopjdgd) lets you capture web content directly into your Xelora knowledge base. Select text, images, or entire pages in the browser and save them as knowledge entries with one click — no copy-paste or file upload needed.


## 📱 WeChat Mini Program

The [Xelora Mini Program](./miniprogram/README.md) provides a lightweight mobile client for configuring Xelora API access, selecting knowledge bases, importing URLs, and asking knowledge chat from WeChat.


## 🦞 ClawHub Skill

[**Xelora ClawHub Skill**](https://clawhub.ai/lyingbug/xelora) is a Xelora skill published on the ClawHub platform. Once installed, it enables document import (file / URL / Markdown), hybrid search (vector + keyword) across knowledge bases, and knowledge entry management — all through the Xelora REST API.
...
`xelora` is the official CLI for driving the API from a terminal or AI agent.
...
v0.9 ships bundled Agent Skills (`xelora-rag-search`, `xelora-shared`), adds
`session stop`, and harmonizes auth/profile workflows (see [`cli/CHANGELOG.md`](./cli/CHANGELOG.md)).

```bash
xelora auth login --host https://kb.example.com
xelora kb list
xelora link --kb my-knowledge-base    # bind the current directory
...
Xelora serves as the core technology framework for the [WeChat Dialog Open Platform](https://chatbot.weixin.qq.com), providing a more convenient usage approach:

- **Zero-code Deployment**: Simply upload knowledge to quickly deploy intelligent Q&A services within the WeChat ecosystem, achieving an "ask and answer" experience
- **Efficient Question Management**: Support for categorized management of high-frequency questions, with rich data tools to ensure accurate, reliable, and easily maintainable answers
- **WeChat Ecosystem Integration**: Through the WeChat Dialog Open Platform, Xelora's intelligent Q&A capabilities can be seamlessly integrated into WeChat Official Accounts, Mini Programs, and other WeChat scenarios, enhancing user interaction experiences
...
Welcome to submit [Issues](https://github.com/Tencent/Xelora/issues) or Pull Requests.
...
**Important:** Starting from v0.1.3, Xelora includes login authentication functionality to enhance system security. For production deployments, we strongly recommend:

- Deploy Xelora services in internal/private network environments rather than public internet
...
[![Contributors](https://contrib.rocks/image?repo=Tencent/Xelora)](https://github.com/Tencent/Xelora/graphs/contributors)
...
<a href="https://www.star-history.com/#Tencent/Xelora&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Tencent/Xelora&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Tencent/Xelora&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Tencent/Xelora&type=date&legend=top-left" />
 </picture>
</a>
