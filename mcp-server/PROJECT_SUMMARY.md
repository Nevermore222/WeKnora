...
├── 📦 核心文件
│   ├── __init__.py              # 包初始化文件
│   ├── xelora_mcp_server.py   # MCP 服务器核心实现
...
# 2. 设置环境变量
export XELORA_BASE_URL="http://localhost:8080/api/v1"
export XELORA_API_KEY="your_api_key"
...
2. **连接错误**: 检查 `XELORA_BASE_URL` 设置
3. **认证错误**: 验证 `XELORA_API_KEY` 配置
...
**项目状态**: ✅ 完成并可投入使用
**项目仓库**: https://github.com/NannaOlympicBroadcast/XeloraMCP
**最后更新**: 2025年10月
**版本**: 1.0.0